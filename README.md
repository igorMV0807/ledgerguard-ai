...
> **Current status:** the live portfolio demo is connected to a dedicated, isolated Supabase sandbox with synthetic data. No production system is used.
...
- anonymous demo sessions and persistent human decisions in the isolated Supabase sandbox;
